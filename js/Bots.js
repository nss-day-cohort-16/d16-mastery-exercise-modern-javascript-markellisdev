...
let Battledome = {}
	...
	/* Base ROBOT ------------- */
	Battledome.Player.Model = function Model() {
		this.weapon = "shockwave";
		this.health = 0;
		this.damage = 0;
	};
	Battledome.Player.Model.prototype = new Battledome.Player();
	...
	Battledome.Player.Drone = function Drone() {
		this.minHealth = 50;
		this.maxHealth = 100;
		this.health = Math.floor(Math.random() * (this.maxHealth - this.minHealth +1)) + this.minHealth;
		this.skill = "flying";
	};
	Battledome.Player.Drone.prototype = new Battledome.Player.Model();

	// var drone = new Battledome.Combatants.Drone();
	// console.log("Drone", drone);


	Battledome.Player.Luna_X_2000 = function Luna_X_2000() {
		this.speed = 70;
		this.img = `http://www.panzerbaer.de/helper/pix/bw_drohne_luna_katapult-001.jpg`
	};
	Battledome.Player.Luna_X_2000.protype = new Battledome.Player.Drone();
